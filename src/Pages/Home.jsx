        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            ...
            <div className="p-6 bg-black border-2 border-purple-500 rounded-lg shadow-lg hover:shadow-2xl transition">
              ...
              <p className="text-gray-700 mt-2 font-bold">Personalized recommendations based on your skills and interests.</p>
            </div>
            {/* Feature 2 */}
            <div className="p-6 bg-black rounded-lg shadow-lg hover:shadow-2xl transition border-2 border-purple-500">
              ...
              <p className="text-gray-700 mt-2 font-bold">Learn from industry professionals with years of experience.</p>
            </div>
            {/* Feature 3 */}
            <div className="p-6 bg-black border-2 border-purple-500 rounded-lg shadow-lg hover:shadow-2xl transition">
              <h3 className="text-2xl font-bold text-purple-600">Job Assistance</h3>
              <p className="text-gray-700 mt-2 font-bold">Get access to exclusive job opportunities and internships.</p>
            </div>
          </div>
        </div>
      </section>
